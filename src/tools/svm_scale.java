...
//			System.out.print(index + ":" + value + " ");
	...
	private synchronized void run(String []argv, String save_path) throws IOException
	{
		int i,index;
		...
		String data_filename = null;
                ...
                BufferedWriter databw=new BufferedWriter(new FileWriter(save_path));
		...
		while(readline(fp) != null)
		{
			...
			for(i=next_index;i<= max_index;i++)
				output(i, 0);
                        xline=target+" "+xline;
                        databw.write(xline);
                        //print on console the current line
//                        System.out.println(xline);
	...
	public static void main(String argv[],String save_path) throws IOException
	{
		svm_scale s = new svm_scale();
		s.run(argv,save_path);
	}
}
